...
public class Server 
{
	public static void main(String[] args) throws IOException 
	{
		...
		System.out.print("Hi I am the Server. Enter the port no. on which you wish to start server: ");
		...
		{
			receivedData = dataInputStream.readUTF(); // Accept message from Client in UTF format
			System.out.println("Client: " + receivedData);	// print
			System.out.print("Server: ");	// Write the message in UTF format to send to client
